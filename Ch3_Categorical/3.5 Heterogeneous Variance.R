...
pdf("/Users/craig/Documents/GitHub/blimp-book/run_logs/3.5 Distribution Plot.pdf", width = 8.5, height = 11)
...
pdf("/Users/craig/Documents/GitHub/blimp-book/run_logs/3.5 Residuals Plot.pdf", width = 8.5, height = 11)
