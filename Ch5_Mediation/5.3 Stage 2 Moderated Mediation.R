...
pdf("/Users/craig/Documents/GitHub/blimp-book/run_logs/5.3 Distribution Plot.pdf", width = 8.5, height = 11)
...
pdf("/Users/craig/Documents/GitHub/blimp-book/run_logs/5.3 Residuals Plot.pdf", width = 8.5, height = 11)
